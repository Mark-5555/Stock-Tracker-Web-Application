...
<div class="jumbotron">
    ...
    <h1 class="display-4">Welcome to Mark's project</h1>
    <!-- TODO change Date/Semester accordingly -->
    <p class="lead">This is for the Summer semester of IT202 2025</p>
    <p>
        <a class="btn btn-primary" href="<?php echo $BASE_PATH;?>/register.php">Register</a>
        <a class="btn btn-secondary" href="<?php echo $BASE_PATH;?>/login.php">Login</a>
    </p>
</div>